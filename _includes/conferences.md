...
<ul style="margin:0 0 20px;">
  ...
  <li style="margin-bottom:10px;">
    ...
    <em>Digital Health Program Improves Quality of Life in Rheumatoid Arthritis: A Retrospective Analysis of Real-World Data</em><br>
    5th Digital Rheumatology Day &nbsp;·&nbsp; Berlin, Germany
  </li>

  <li style="margin-bottom:10px;">
    <strong>Jul 2022</strong> &nbsp;·&nbsp;
    <em>Variable Selection Discrepancies of Cox Models Using Backward Selection or LASSO – Blame the Random Seed?</em><br>
    31st International Biometric Conference &nbsp;·&nbsp; Riga, Latvia
  </li>
